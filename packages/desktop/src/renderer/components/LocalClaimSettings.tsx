...
export function LocalClaimSettings() {
  ...
  return <section className="desktop-settings" aria-label="Local claim review settings">
    ...
    <p><strong>Research preview.</strong> Suggests evidence matches for cited statements, running entirely on this Mac
    ...
    <details>
      ...
      <p>{status?.sampleMsPerClaim ? `Measured CPU sample on this laptop: ${(status.sampleMsPerClaim / 1000).toFixed(1)} s per short statement. Longer passages take more.` : 'Run a local speed sample to improve batch estimates.'}
